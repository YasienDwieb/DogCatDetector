...
train_desc=list()
with open ('Training 1000-30/train_desc.txt', 'rb') as fp:
     train_desc = pickle.load(fp)

train_labels=list()
with open ('Training 1000-30/train_labels.txt', 'rb') as fp:
     train_labels = pickle.load(fp)

dictionary =np.load('Training 1000-30/dictionary.npy')
